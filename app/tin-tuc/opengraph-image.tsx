...
export const alt = "Tin tức bất động sản — 1992 Land";
  ...
  return new ImageResponse(
    (
      <div style={{ background: "linear-gradient(135deg, #071121 0%, #0D1E38 60%, #1E3A60 100%)", width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "flex-end", fontFamily: "sans-serif", padding: "60px 72px", position: "relative" }}>
        ...
        <div style={{ fontSize: 14, color: "#C49730", letterSpacing: "0.4em", marginBottom: 24, display: "flex" }}>· 1992 ·  Tin tức & phân tích</div>
        <div style={{ fontSize: 56, fontWeight: 700, color: "#FFFFFF", lineHeight: 1.1, marginBottom: 8, display: "flex" }}>Tin tức BĐS cập nhật mỗi tuần</div>
        <div style={{ fontSize: 20, color: "rgba(255,255,255,0.5)", marginBottom: 48, display: "flex" }}>Thị trường · Pháp lý · Đầu tư · Phân tích chuyên sâu</div>
